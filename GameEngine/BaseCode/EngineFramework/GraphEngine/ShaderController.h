...
public:
    ...
    static void AddShader(int index,Shader*shader)
    {
//        GetShaderController()->addShader(shader->getName(),shader,"","","");
    }
    static void AddShader(int index,std::string shaderName,std::string vertexPath,std::string fragmentPath)
    {
//        GetShaderController()->addShader(shaderName,nullptr,vertexPath,fragmentPath);
    }
...
private:
    ...
    void addShader(int index,std::string shaderName,Shader*shader,std::string vertexPath,std::string fragmentPath)
    {
